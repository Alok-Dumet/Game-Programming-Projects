...
public:
    ...
    // ————— METHODS ————— //
    Entity();
    Entity(GLuint texture_id, float speed, glm::vec3 acceleration, float boost_power, int walking[4][4], float animation_time,
    ...
    bool      const get_wincon();
    bool      const get_land_spot();
    bool      const get_mountain();
    bool      const get_losecon();
    ...
    void const set_boosting_power(float new_boosting_power) { m_boosting_power = new_boosting_power;}
    void const set_width(float new_width) {m_width = new_width; }
    void const set_height(float new_height) {m_height = new_height; }
    void const set_land_spot(bool spot);
    void const set_mountain(bool spot);
