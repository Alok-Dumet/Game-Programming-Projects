...
enum AIState    { ATTACKING, IDLE, WALKING, PATROLLING, JUMPING};           //ADDED PATROLLING AND JUMPING
...
private:
    ...
    float wall_hit = -1;                                        //switch directions for walkin
...
public:
    ...
    bool      const get_special() const { return special; }
    ...
    void const set_special(bool mark) { special = mark; };
